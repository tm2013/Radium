...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 RADS"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 RADS"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 RADS"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 RADS"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 RADS", 0));
#ifndef QT_NO_TOOLTIP
